...
<div class="row">
  <div class="col-lg-12  grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">{{ __('words.programDeleted') }}</h4>       
                  ...
                  @foreach ($programs as $item)
                      <tr>
                        ...
                        <td>
                          ...
                          href="{{url('deleteProgramForce',$item->id)}}">{{ __('words.delete') }}</a>
                          <a class="btn btn-success" href="{{url('restorePrograms',$item->id)}}">{{ __('words.restore') }}</a>
                        </td>
                      </tr>
                  @endforeach     
                  @else
                      <tr><td  colspan="8"><b>There are not Programs to Display</b></td></tr>
                  @endif
                </tbody>
              </table>
