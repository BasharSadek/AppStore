              ...
              @foreach ($users as $item)
                  <tr>
                    ...
                    <td>
                      ...
                      href="{{url('deleteUserForce',$item->id)}}">{{ __('words.delete') }}</a>
        <a class="btn btn-success" href="{{url('restoreUsers',$item->id)}}">{{ __('words.restore') }}</a>
                    </td>
                  </tr>
              @endforeach     
              @else
                  <tr><td  colspan="8"><b>There are not Users to Display</b></td></tr>
              @endif
            </tbody>
          </table>
